...
appendMessage(
  "¡Hola! Soy tu asistente virtual de salud. 😊 Por favor, dime los nombres de los medicamentos que estás tomando o sobre los que tienes dudas en minusculas, el nombre del principio activo lo puedes ver pequeño en la caja del medicamento. Si deseas ver el listado de medicamentos digita *mostrar* y aparecera el listado actual de medicamentos, si deseas reiniciar el chat digita *reiniciar*, digita el nombre del medicamento del que tengas dudas y presiona el boton *enviar*",
  "bot"
);
